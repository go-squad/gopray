const EmptyBucketIllustration = ({ className }: { className?: string }) => {
  return (
    <svg
      className={className}
    ...
    >
      ...
      ></path>
      <circle cx="190.154" cy="24.955" r="20" fill="#ff2b5c"></circle>
      ...
      ></path>
      <circle cx="433.636" cy="105.174" r="20" fill="#ff2b5c"></circle>
      <circle cx="433.636" cy="105.174" r="12.182" fill="#fff"></circle>
    </svg>
  );
};

export default EmptyBucketIllustration;
